...
class PTKSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class PTKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(PTKDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new PTKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PTKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PTKDateTimeConverter dateTimeConverter = new PTKStandardDateTimeConverter();

    public PTKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PTKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PTKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PTKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PTKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=PTKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
