...
class UVASoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class UVAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(UVADateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new UVAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static UVADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static UVADateTimeConverter dateTimeConverter = new UVAStandardDateTimeConverter();

    public UVAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public UVAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new UVAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=UVAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,UVAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=UVAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
