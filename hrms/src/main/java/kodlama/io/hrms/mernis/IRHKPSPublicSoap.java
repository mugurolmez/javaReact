...
public class IRHKPSPublicSoap
{
    ...
    public IRHKPSPublicSoap(){}

    public IRHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IRHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IRHExtendedSoapSerializationEnvelope envelope= new IRHExtendedSoapSerializationEnvelope(IRHExtendedSoapSerializationEnvelope.VER11);
