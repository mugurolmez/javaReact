...
class IRHSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class IRHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IRHDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new IRHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IRHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IRHDateTimeConverter dateTimeConverter = new IRHStandardDateTimeConverter();

    public IRHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IRHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IRHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IRHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IRHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IRHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
