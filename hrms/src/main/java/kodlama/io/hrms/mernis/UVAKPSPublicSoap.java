...
public class UVAKPSPublicSoap
{
    ...
    public UVAKPSPublicSoap(){}

    public UVAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public UVAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UVAExtendedSoapSerializationEnvelope envelope= new UVAExtendedSoapSerializationEnvelope(UVAExtendedSoapSerializationEnvelope.VER11);
