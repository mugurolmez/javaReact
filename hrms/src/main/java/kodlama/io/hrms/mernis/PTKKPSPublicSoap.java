...
public class PTKKPSPublicSoap
{
    ...
    public PTKKPSPublicSoap(){}

    public PTKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PTKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PTKExtendedSoapSerializationEnvelope envelope= new PTKExtendedSoapSerializationEnvelope(PTKExtendedSoapSerializationEnvelope.VER11);
